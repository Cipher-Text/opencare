  ...
  return (
    <Navbar>
      ...
      >
        ...
        {/* Card List */}
        {/* <Card title="Doctors">
          <Card style={{ background: geekblue.at(1) }} type="inner">
            <Flex wrap="wrap" gap="large">
              ...
              >
                <Title level={5}>Hospital 1</Title>
          ...
          <Card
            style={{ marginTop: 16, background: geekblue.at(1) }}
            type="inner"
          >
            <Flex wrap="wrap" gap="large">
              <Image
              ...
              >
                <Title level={5}>Hospital 2</Title>
          ...
          >
            <Flex wrap="wrap" gap="large">
              ...
              >
                <Title level={5}>Hospital 3</Title>
        ...
        >
          <Text>This is about doctors list.</Text>
        </div>
      </Content>
    </Navbar>
  );
